...
double leerDecimal(Map<String, dynamic> json, String campo) {
  final valor = json[campo];
  // En JSON, 25000 y 25000.0 son el mismo número. En Dart, int y double NO
  // lo son: `valor as double` revienta con 25000. Por eso se pasa por num.
  ...
  return List<String>.unmodifiable(
    valor.map(
      (e) => e is String
          ? e
          : throw CampoInvalido(
              campo, 'todos sus elementos deben ser texto', e),
    ),
  );
}
